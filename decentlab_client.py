...
def query(domain: str=DOMAIN, api_key: str=API_KEY, time_filter='',
          device='//', location='//',
...
if __name__ == "__main__":
    ...
    path = pathlib.WindowsPath(r"C:\Users\dischand\switchdrive\UWO\Arbeiten und Artikel\UWO_Data_paper\decentlab_data_correction")

    devices = ["317", "319", "319", "330", "331", "907"]

    time_filter = f"time >= '{'2019-06-09 00:00:00'}' AND time <= '{'2019-06-17 23:59:59'}'"
